            ...
            return (
              ...
              >
                ...
                <div className="relative">
                  <Icon className={`w-5 h-5 ${isActive ? 'text-white stroke-[2.5]' : 'text-[#8C7E72]'}`} />
                ...
                <span className={`text-[10px] font-semibold mt-0.5 leading-tight ${isActive ? 'text-white font-bold' : 'text-[#8C7E72]'}`}>
                  {item.label}
                </span>
              </motion.button>
            );
